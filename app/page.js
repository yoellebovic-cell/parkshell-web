export default function Home() {
  return (
    <main className="min-h-screen bg-[#050505] text-white">
      {/* NAVBAR */}
      <nav className="sticky top-0 z-50 border-b border-zinc-900 bg-[#050505]/80 backdrop-blur">
      ...
      <section className="mx-auto flex max-w-6xl flex-col items-center px-6 py-28 text-center">
        ...
        <p className="mt-8 max-w-2xl text-xl leading-9 text-zinc-400">
          ParkShell automatically detects your city, routes you
          to the correct parking provider, and keeps track of
          your parking session with one unified timer.
        </p>
        ...
        <div className="mt-24 flex justify-center">
          <div className="w-[320px] rounded-[40px] border border-zinc-700 bg-zinc-900 p-4 shadow-2xl shadow-lime-500/10">
            <div className="rounded-[32px] bg-[#0A0A0A] p-6">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
          <div className="rounded-3xl border border-zinc-800 bg-zinc-900/40 p-8">
            ...
            <p className="mt-4 text-zinc-400">
              ParkShell detects where you parked and routes
              you to the correct parking provider instantly.
            </p>
          </div>
      ...
      >
        ...
        <div className="mt-16 grid gap-8 md:grid-cols-3">
          ...
          <div className="rounded-3xl border border-zinc-800 p-8">
            ...
            <p className="mt-4 text-zinc-400">
              ParkShell opens the correct vendor app and
      ...
      <section className="mx-auto max-w-4xl px-6 py-24">
        <div className="rounded-[40px] border border-zinc-800 bg-zinc-900/40 p-12 text-center">
          <p className="text-sm font-bold uppercase tracking-wide text-lime-400">
            Early Access
          </p>
          ...
          <p className="mx-auto mt-6 max-w-2xl text-xl text-zinc-400">
            Be among the first users to simplify parking
            across every city.
          </p>
          ...
          <div className="mx-auto mt-10 flex max-w-xl flex-col gap-4 md:flex-row">
            <input
              ...
              className="flex-1 rounded-2xl border border-zinc-700 bg-black px-6 py-4 text-lg outline-none"
            />

            <button className="rounded-2xl bg-lime-400 px-8 py-4 text-lg font-black text-black">
              Join
            </button>
          </div>
        </div>
